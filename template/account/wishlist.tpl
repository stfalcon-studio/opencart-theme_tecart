      ...
      <tbody id="wishlist-row<?php echo $product['product_id']; ?>">
        <tr>
          ...
          <td class="price"><?php if ($product['price']) { ?>
            ...
            <?php } ?></td>
          <td class="action"><img src="catalog/view/theme/tecart/image/cart-add.png" style="cursor:pointer;" alt="<?php echo $button_cart; ?>" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" />&nbsp;&nbsp;<a href="<?php echo $product['remove']; ?>"><img src="catalog/view/theme/tecart/image/remove.png" alt="<?php echo $button_remove; ?>" title="<?php echo $button_remove; ?>" /></a></td>
        </tr>
      </tbody>
      <?php } ?>
    </table>
