...
<!-- breadcrumbs old place -->
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    ...
    <div class="content">
      <div class="left"><?php echo $entry_firstname; ?> <span class="required">*</span><br />
      ...
      <div class="right"><?php echo $entry_order_id; ?> <span class="required">*</span><br />
    ...
    <div id="return-product">
      <div class="content">
        <div class="return-product">
          <div class="return-name"><b><?php echo $entry_product; ?></b> <span class="required">*</span><br />
