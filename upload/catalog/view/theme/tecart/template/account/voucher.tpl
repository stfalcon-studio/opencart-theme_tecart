...
<!-- breadcrumbs old place -->
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
    <table class="form">
      <tr>
        <td><?php echo $entry_to_name; ?> <span class="required">*</span></td>
      ...
      <tr>
        <td><?php echo $entry_to_email; ?> <span class="required">*</span></td>
      ...
      <tr>
        <td><?php echo $entry_from_name; ?> <span class="required">*</span></td>
      ...
      <tr>
        <td><?php echo $entry_from_email; ?> <span class="required">*</span></td>
      ...
      <tr>
        <td><?php echo $entry_theme; ?> <span class="required">*</span></td>
      ...
      <tr>
        <td><?php echo $entry_amount; ?> <span class="required">*</span></td>
